...
//       >
//         {/* Navbar */}
//         <header className="flex justify-between items-center md:px-30 lg:px-50 py-20">
//           <img src="/images/logo.svg" alt="SuiLift Logo" className="h-10" />
//           <nav className="bg-blue-500 rounded-full p-3 flex items-center md:space-x-7 lg:space-x-16 md:text-xl lg:text-2xl">
...
//             New Features
//           </button>
//           <button className="bg-transparent text-white border border-white px-4 py-2 rounded-full flex items-center hover:bg-gray-800">
...
//         <h1 className="text-7xl font-extrabold mb-4 md:px-10 lg:px-120">
...
//       </section>
//       {/* Why SuiLift Section */}
//       <section id="why" className="md:px-10 lg:px-60 py-16 text-center">
...
//       </section>
//       {/* Step Numbers */}
//       <div className="mt-10 flex justify-center items-center w-full max-w-3xl mx-auto text-sm font-bold mb-10">
...
//             Fund Your Card Now
//           </button>
//           <button className="border border-white px-6 py-2 rounded-md font-semibold">
//             Watch a Demo
//           </button>
//         </div>
//         {/* Video Link */}
...
//             <div key={idx} className="bg-gray-900 rounded-lg p-6 text-center">
...
//       >
//         <div className="mt- flex justify-start w-full lg:ml-200 md:ml-30">
