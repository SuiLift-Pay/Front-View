...
const ATMCard = ({
  ...
  return (
    <div className="flex justify-center items-center w-full">
      <div className="w-full max-w-[350px] sm:max-w-[400px] aspect-[16/10] perspective-1000"
        ...
        <div className={`relative w-full h-full transition-transform duration-700 transform-style-preserve-3d ${isFlipped ? 'rotate-y-180' : ''}`}>
          ...
          <div className="absolute inset-0 backface-hidden rounded-2xl overflow-hidden shadow-2xl">
            <div className="w-full h-full bg-gradient-to-br from-purple-900 via-blue-800 to-blue-600 relative">
              ...
              <div className="absolute inset-0 opacity-30">
                <svg className="w-full h-full" viewBox="0 0 400 240" fill="none">
                  <path d="M0,80 Q100,40 200,80 T400,80 L400,120 Q300,160 200,120 T0,120 Z"
                    fill="url(#wave1)" />
                  <path d="M0,120 Q100,80 200,120 T400,120 L400,160 Q300,200 200,160 T0,160 Z"
                    fill="url(#wave2)" />
                  <defs>
                    <linearGradient id="wave1" x1="0%" y1="0%" x2="100%" y2="0%">
                      <stop offset="0%" stopColor="#8B5CF6" stopOpacity="0.8" />
              ...
              <div className="absolute flex justify-between items-end w-[88%] left-3 right-3 sm:left-5 sm:right-5 bottom-5 md:bottom-12">
                <div className="">
                  <p className="text-gray-200 text-[0.57rem] sm:text-xs uppercase tracking-wide ">Card Holder</p>
                  <p className="text-white font-semibold text-[0.77rem] sm:text-lg tracking-wide ">{holderName}</p>
                </div>
                <div className="text-right">
                  <p className="text-gray-200 text-[0.6rem] sm:text-xs uppercase tracking-wide ">Expires</p>
                  <p className="text-white font-semibold text-[0.57rem] sm:text-lg mb-2 md:mb-1">{expiryDate}</p>
                </div>
              </div>
              {/* Mastercard */}
            ...
            <div className="w-full h-full bg-gradient-to-br from-purple-900 via-blue-800 to-blue-600">
              ...
              <div className="px-3 pt-2 md:pt-7 sm:px-6">
                <div className="bg-white rounded py- md:py-2 px-4 w-12 md:w-24 ml-auto">
                  <span className="text-black font-mono text-sm sm:text-base">{cvv}</span>
                </div>
